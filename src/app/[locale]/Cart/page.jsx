                      ...
                      return (
                        <tr key={index} className="border-t">
                          <td className="py-4 px-4  hidden lg:flex   items-center space-x-4">
                            <img
                              src={`/public/CarModels/${item.image}`}
                              alt={item.name}
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-2">
                  <input
                    ...
                    className="form-checkbox"
                  />
                  <label htmlFor="standard">{t("standardShipping")}</label>
                </div>
                <div className="flex items-center space-x-2">
                  <input
                    type="checkbox"
                    ...
                    className="form-checkbox"
                  />
                  <label htmlFor="express">{t("expressShipping")}</label>
                </div>
                <div className="flex items-center space-x-2">
                  <input
                    type="checkbox"
                    ...
                    className="form-checkbox"
                  />
                  <label htmlFor="overnight">{t("overnightShipping")}</label>
                </div>
              </div>
            </div>
          </div>
        ...
        <div>
          <div className="bg-white shadow-md rounded-lg p-6">
            ...
            <button className="bg-blue-600 text-white w-full p-2 rounded mt-4">
              <FaShoppingBag className="mr-2 h-4 w-4 inline-block" />{" "}
              {t("proceedToCheckout")}
            </button>
          </div>
        </div>
